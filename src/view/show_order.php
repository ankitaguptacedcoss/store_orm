...
<body>
  ...
  echo '<div class=" d-flex justify-content-around"><h4 class=" mb-2"><strong> Recent Orders !!</strong></h4>';
  echo '<a href="../view/allorders_display.php">View All orders</a></div>';
  echo ' <div class="row mt-2">';
  //query to fetch recent orders came to admin
  $order_user = Order::find('all', array('limit' => 5, 'order' => 'order_id desc'));
