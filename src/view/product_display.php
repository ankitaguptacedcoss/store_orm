...
<?php
   ...
   echo '<div class=" d-flex justify-content-around"><h4 class=" mb-2"><strong> Recent Products !!</strong></h4>';
echo '<a href="../view/allproducts_display.php">View All Products</a></div>';
     echo ' <div class="row mt-2">';
     //query to fetch recent products uploaded by admin
     $user_n=Product::find('all', array('limit' => 5, 'order' => 'product_id desc'));
