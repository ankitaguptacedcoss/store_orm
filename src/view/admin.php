                        ...
                        <div class="card-body px-4 py-5 px-md-5">
                            ...
                            <form action="../controller/upload_product.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="number" id="form3Example3" class="form-control" name="product_price" />
                                    <label class="form-label" for="form3Example3">Product Price</label>
                                </div>
                                <div class="form-outline mb-4">
                                    <input class="form-control form-control-lg" name="fileToUpload" id="formFileLg" type="file" required />
                                    <div class="small text-muted mt-2">Upload image or any other relevant file. Max file
                                        size 50 MB</div>
                                </div>
                                <!-- stock input -->
                                <div class="form-outline mb-4">
                                    <input type="number" id="form3Example4" class="form-control" name="product_stock" required />
