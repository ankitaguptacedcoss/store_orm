...
<body>
  ...
  echo '<div class=" d-flex justify-content-around"><h4 class=" mb-2"><strong> Recent Registered Users !!</strong></h4>';
  echo '<a href="../view/allusers_display.php">View All Users</a></div>';
  echo ' <div class="row mt-2">';
  //query to fetch recent  users registered 
  $users = User::find('all', array('limit' => 5, 'order' => 'user_id desc'));
